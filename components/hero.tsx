...
export default function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-gradient-to-br from-[#07182f] via-[#0B2447] to-[#123B73] min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-5 mt-10">
            ...
            <a
              ...
              className="bg-red-600 hover:bg-red-700 transition px-8 py-4 rounded-xl text-white font-semibold flex items-center gap-3 shadow-lg hover:scale-105"
            >
              <Phone size={20} />
              Call Now
            </a>
            ...
            <a
              ...
              className="border border-white hover:bg-white hover:text-[#07182f] transition px-8 py-4 rounded-xl text-white font-semibold flex items-center gap-3 hover:scale-105"
            >
        ...
        <div className="flex justify-center">
          ...
          <Image
            ...
            height={700}
            priority
            className="object-contain drop-shadow-[0_30px_60px_rgba(0,0,0,0.55)] hover:scale-105 transition duration-500"
          />
